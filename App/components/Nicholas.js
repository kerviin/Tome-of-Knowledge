...
import { View, StyleSheet, Text, ImageBackground, SafeAreaView, ScrollView,StatusBar } from 'react-native';
import 'react-native-gesture-handler';
import image from '../../assets/content.png'
import Icon from 'react-native-vector-icons/FontAwesome';

const navigation = navigation;
export default function Nicholas({navigation}){
    return(
        <SafeAreaView style={styles.container}>
            <ScrollView style={styles.scrollView}>
                <ImageBackground source={image} style={styles.Wallpaper}>
                    <Icon name="arrow-left" style={styles.arrow} type="entypo" onPress={ () => navigation.navigate('Story1', {name: 'Story1'})}/>
                    <Text style={styles.body}>{'\t'}{'\t'}{'\t'}{'\t'}Not for the first time, an argument had broken out over breakfast at
                        ...
                        Harry’s room.</Text>
                        <Text style={styles.body}>{'\t'}{'\t'}{'\t'}{'\t'}“Third time this week!” he roared across the table. “If you can’t control
                        ...
                        </Text><Text style={styles.body}>{'\t'}{'\t'}{'\t'}{'\t'}“Do I look stupid?” snarled Uncle Vernon, a bit of fried egg dangling
                        ...
                        <Text style={styles.body}>“I want more bacon.”“There’s more in the frying pan, sweetums,” said Aunt Petunia, turning
                        misty eyes on her massive son. “We must build you up while we’ve got the
                        chance. . . . </Text><Text style={styles.body}>I don’t like the sound of that school food. . . .”
                        ...
                        kitchen chair, grinned and turned to Harry.</Text>
                        “Pass the frying pan.”</Text>
                        <Text style={styles.body}>“You’ve forgotten the magic word,” said Harry irritably.
                        ...
                        “All right,” said Harry, “all right . . .”Uncle Vernon sat back down, breathing like a winded rhinoceros and
                        ...
                        Vernon had been treating him like a bomb that might go off at anymoment, because Harry Potter wasn’t a normal boy. As a matter of fact, he
                        ...
                        and neckless, with an enormous black mustache; Aunt Petunia was horsefaced and bony; Dudley was blond, pink, and porky. Harry, on the other
                        hand, was small and skinny, with brilliant green eyes and jet-black hairthat was always untidy. He wore round glasses, and on his forehead was a
                        ...
                        Uncle Vernon.Harry went back to his toast. Of course, he thought bitterly, Uncle
                        ...
                        said Harry dully.“Precisely. Now, we should aim to get in a few good compliments at
                        ...
                        breath:
                        “Happy birthday to me . . . happy birthday to me . . .”No cards, no presents, and he would be spending the evening pretending
                        ...
                        remembering his livid face, his wide, mad eyes —Harry suddenly sat bolt upright on the garden bench. He had been
                        ...
                        back toward the house. “MUUUUM! He’s doing you know what!”Harry paid dearly for his moment of fun. As neither Dudley nor the
                        ...
                        furious face appeared at the foot of the stairs.“Remember, boy — one sound —”
                        Harry crossed to his bedroom on tiptoe, slipped inside, closed the door,
                        and turned to collapse on his bed.
                        The trouble was, there was already someone sitting on it. To be contune....   
                        </Text>
                </ImageBackground>
            </ScrollView>
        </SafeAreaView>
